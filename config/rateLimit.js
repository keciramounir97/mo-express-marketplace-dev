...
export const autocompleteLimiter = (req, res, next) => {
  if (!_autocompleteLimiter) {
    _autocompleteLimiter = rateLimit({
  ...
  return _autocompleteLimiter(req, res, next);
};
